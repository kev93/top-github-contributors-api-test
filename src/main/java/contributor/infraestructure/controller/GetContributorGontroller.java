...
public class GetContributorGontroller {
    ...
    public List<Contributor> contributors(
        ...
        RESTApiConsumer apiConsumer = new RESTApiConsumer(requestMaker);
        ...
        SearchContributorByCityCommand command = new SearchContributorByCityCommand(cityName, sort, size, order);
        SearchContributorByCityCommandHandler commandHandler = new SearchContributorByCityCommandHandler(
            searcher
        );
